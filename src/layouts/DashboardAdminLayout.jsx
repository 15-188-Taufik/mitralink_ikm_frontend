...
const IkonVerifikasi = () => <Icon path="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />;
const IkonLaporan = () => <Icon path="M9 17v-2m3 2v-4m3 4v-6m2 10V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2h14a2 2 0 002-2z" />;
...
const DashboardAdminLayout = () => {
  ...
  const SidebarContent = () => (
    <div className="flex flex-col flex-1 h-full">
      ...
      <nav className="mt-6 px-2 space-y-2 flex-1">
        <NavLinkItem to="/dashboard-admin" icon={<IkonDashboard />} label="Dashboard" end />
        <NavLinkItem to="/direktori" icon={<IkonDirektori />} label="Lihat Direktori" />
        <NavLinkItem to="/dashboard-admin/verifikasi" icon={<IkonVerifikasi />} label="Verifikasi IKM" />
        <NavLinkItem to="/dashboard-admin/laporan" icon={<IkonLaporan />} label="Laporan Pendapatan" />
      </nav>
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* === SIDEBAR === */}
      <aside className={`fixed inset-y-0 left-0 w-64 bg-gray-900 text-gray-100 flex-shrink-0 z-50 transform
      ...
      <div className="flex-grow flex flex-col">
        ...
        <header className="md:hidden bg-white shadow-md sticky top-0 z-30">
          <div className="flex items-center justify-between p-4">
            ...
            <span className="text-lg font-bold text-blue-600">MitraLink Admin</span>
          </div>
        </header>
